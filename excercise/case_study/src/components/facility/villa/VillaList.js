            ...
            <div style={{marginTop: "100px"}} className="container">
                <div className="content row">
                    <div className="d-flex">
                        <h2 style={{position: "relative", left: "500px"}}>Villa List</h2>
                        <Link to="/villa/create">
                        ...
                        <div className="container col-3" key={villa.id}>
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">Villa size : {villa.size} m<sup>2</sup></p>
                                    <div className="d-flex" style={{justifyContent: "right"}}>
                                        <div>
                                            <Link to={`/villa/edit/${villa.id}`} style={{textDecoration: "none"}}>
                                        ...
                                        <div>
                                            <button className="delete-button" onClick={() => deleteModal(villa)}>
