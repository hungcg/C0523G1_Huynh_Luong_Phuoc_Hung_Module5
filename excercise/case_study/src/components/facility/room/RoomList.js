            ...
            <div style={{marginTop: "100px"}} className="container">
                <div className="content row">
                    <div className="d-flex">
                        <h2 style={{position: "relative", left: "500px"}}>Room List</h2>
                        <Link to="/room/create">
                            ...
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="d-flex" style={{justifyContent: "right"}}>
                                        <div>
                                            <Link to={`/room/edit/${room.id}`} style={{textDecoration: "none"}}>
                                        ...
                                        <div>
                                            <button className="delete-button" onClick={() => deleteModal(room)}>
