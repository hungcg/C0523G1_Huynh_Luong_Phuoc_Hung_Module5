...
import {findAllHouse} from "../../../service/house/house_service";
            ...
            <div style={{marginTop: "100px"}} className="container">
                <div className="content row">
                    <div className="d-flex">
                        <h2 style={{position: "relative", left: "500px"}}>House List</h2>
                        <Link to="/house/create">
                            <button style={{position: "relative", top: "10px", left: "850px"}} className="btn"><i
                        ...
                        <div className="container col-3" key={house.id}>
                            <div className="card">
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text">House size : {house.size} m<sup>2</sup></p>
                                    <div className="d-flex" style={{justifyContent: "right"}}>
                                        <div>
                                            <Link to={`/house/edit/${house.id}`} style={{textDecoration:"none"}}>
                                        ...
                                        <div>
                                            <button className="delete-button" onClick={() => deleteModal(house)}>
